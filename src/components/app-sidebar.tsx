      ...
      <SidebarHeader>
        ...
        {onSearchClick && !collapsed && (
          <button
            ...
            className="mx-2 mb-1 flex items-center gap-2 rounded-md border border-sidebar-border bg-sidebar-accent/40 px-2.5 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-foreground"
          >
