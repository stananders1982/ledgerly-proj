...
BEGIN
  ...
  LOOP
    ...
    is_invalid := lead_status IN (
      'need_to_cancel'::public.lead_status,
      'wrong_number'::public.lead_status,
      'never_registered'::public.lead_status,
      'wrong_person'::public.lead_status,
      'no_language'::public.lead_status,
      'under_age'::public.lead_status,
    ...
    INSERT INTO public.leads (
      ...
      lead_notes, ftd_amount > 0 AND NOT is_invalid, created_ts, cid, external_id
    ) RETURNING id INTO new_lead_id;
    imported_count := imported_count + 1;

    IF is_invalid THEN
      matched_entry_id := NULL;
      SELECT e.id INTO matched_entry_id
      FROM public.daily_lead_entries e
      WHERE e.company_id = cid
        AND e.entry_date = created_date
      ...
      ELSE
        ...
        SET received = received + 1, invalid = invalid + 1
    ...
    UPDATE public.leads l SET activation_id = new_activation_id WHERE l.id = new_lead_id;
  ...
  RETURN jsonb_build_object(
    ...
    'invalid_connected', invalid_count,
